      ...
      <section className="projects-section">
        <div className="container">
          <div className="section-title mb-4">
            ...
            <Link href="#works" className="cmn-btn">
              <span>
          ...
          <div className="tab-menu">
            ...
            <button
              className={`${filter === "frontend" ? "active" : ""} no-gutter`}
              type="button"
            ...
            <button
              className={`${filter === "full-stack" ? "active" : ""} no-gutter`}
              type="button"
              ...
              <div className="project-single">
                ...
                <div className="project-single-content">
                  ...
                  >
                    <StarGroup />
                    <blockquote>
                      I have never seen a platform that is completely free,
                      where creatives are given this much power to not just only
                      show their work, but also network, get hired for doing
                      what they enjoy and love. Tabulio is simply the BEST!!
                    </blockquote>
